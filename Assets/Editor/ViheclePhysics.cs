...
public class ViheclePhysics : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        if (!isCreated)
        {
            ...
            if (currentType == Types.FourWD) wheelsConunt = 4;
            if (currentType == Types.ThreeWD) wheelsConunt = 3;
            ...
            if (GUILayout.Button("Create Vihecle", GUILayout.Height(20), GUILayout.Width(100)))
            {
    ...
    private void Create()
    {
       ...
       // newMesh.AddComponent<MeshCollider>();newMesh.GetComponent<MeshCollider>().convex = true;
        ...
        SoundManager1.AddComponent<AudioSource>();//SoundManager1 = CreateAudioSource.NewAudioSource(SoundManager1, "Engine Sound On AudioSource", 5, 0, audio_SO.engineClipOn, true, true, false);
        ...
        #endregion
        #region assign stufs for custom Vihecle type
